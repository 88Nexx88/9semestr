...
type_ir = pd.read_csv("anya\\type_ir.csv")
price_all = numpy.zeros(8)
print(price_all)
print()
print()

filename = 'anya\\1ir.csv'
...
test = [0, 0, 0, 0, 0, round((2635231.0+2941600.0) / 2, 0), 0, 7495047.5, 11233624.0, 0]
print(test)
