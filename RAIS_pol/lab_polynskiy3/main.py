...
print(df_aks)
print('8___________________________________________')
print('Сравнить меры энтропии по п.7 и объяснить их различия.')
print('Все эти значения отличаются друг от друга по причине различного способа расчёта. '
      'd(a)лог имеет такое значение так как вычисляется от натурального логарифма (наименьшее)'
      'd(a)евкл имеет такое значение так как вычисляется с возведением в квадрат (наибольшее значение)'
      'd(a)хем имеет такое значение так как вычисляется без возведения в квадрат')
...
print('10___________________________________________')
print('Сравнить функции доверия по п.9 и объяснить их различия.')
print('Все эти значения отличаются друг от друга по причине различного способа расчёта. '
      'd(a)лог имеет такое значение так как вычисляется от натурального логарифма (наименьшее)'
      'd(a)евкл имеет такое значение так как вычисляется с возведением в квадрат (наибольшее значение)'
      'd(a)хем имеет такое значение так как вычисляется без возведения в квадрат')
